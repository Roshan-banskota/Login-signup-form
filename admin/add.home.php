...
if (isset($_POST['insert'])) {
	...
	//	echo '<script type="text/javascript">
                      //alert("your entry is already in the talele/list. please choose another schedule.");
    ...
    //$insert_Query"INSERT INTO `addtable` (`id`, `faculty`, `course`, `subject`, `room`, `start_time`, `end_time`) VALUES ('null', '$data[0]', '$data[1]', '$data[2]', '$data[3]', '$data[4]', '$data[5]')";
